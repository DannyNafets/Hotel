...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		lblCheckIn.setBounds(68, 136, 239, 14);
		...
		lblTitulo.setBounds(90, 60, 239, 42);
		...
		txtValor.setBounds(82, 329, 80, 33);
		...
		JLabel labelGuardar_1 = new JLabel("$");
		labelGuardar_1.setHorizontalAlignment(SwingConstants.CENTER);
		labelGuardar_1.setForeground(new Color(0, 0, 0));
		labelGuardar_1.setFont(new Font("Dialog", Font.PLAIN, 18));
		labelGuardar_1.setBounds(64, 329, 20, 35);
		panel.add(labelGuardar_1);
