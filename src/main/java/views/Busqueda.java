...
public class Busqueda extends JFrame {
	...
	int cont = 0;
	private ReservaDao reservaDao = new ReservaDao(em);
	private HuespedDao huespedDao = new HuespedDao(em);
		...
		if (cont == 1) {
	        ...
	        Optional.ofNullable(modelo.getValueAt(tbReservas.getSelectedRow(), tbReservas.getSelectedColumn()))
	                .ifPresentOrElse(fila -> {
	                    ...
	                    JOptionPane.showMessageDialog(this, String.format("id %d eliminado con éxito!", id));
	                }, () -> JOptionPane.showMessageDialog(this, "Por favor, elije un item"));
		}
		...
		if (cont == 1) {
	        ...
	        Optional.ofNullable(modelo.getValueAt(tbReservas.getSelectedRow(), tbReservas.getSelectedColumn()))
	                .ifPresentOrElse(fila -> {
	                    ...
	                    JOptionPane.showMessageDialog(this, String.format("id %d modificado con éxito!", id));
	                }, () -> JOptionPane.showMessageDialog(this, "Por favor, elije un item"));
		}
		...
		if (cont == 2) {
	        ...
	        Optional.ofNullable(modeloHuesped.getValueAt(tbHuespedes.getSelectedRow(), tbHuespedes.getSelectedColumn()))
	                .ifPresentOrElse(fila -> {
	                    ...
	                    var huesped = new Huesped(id, nombre, apellido, fechaNacimiento, nacionalidad, telefono, nReserva);
	                    
	                    em.getTransaction().begin();
	                    
	                    this.huespedDao.editar(huesped);
	                    
	                    em.getTransaction().commit();
	                    
	                    
	                    JOptionPane.showMessageDialog(this, String.format("%d item modificado con éxito!", id));
	                }, () -> JOptionPane.showMessageDialog(this, "Por favor, elije un item"));
		}
	...
	private void cargarTablaHuespeds() {
		
		em.getTransaction().begin();
		
		var huespedes = huespedDao.listar(); 
